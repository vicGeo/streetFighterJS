...
let selectCharacter = (character) => {
    ...
    if (player1 =="") {
        ...
        imagePlayer1.innerHTML = `<img class="fighter1" src="assets/img/characters/player1/${player1.name}-stay-p1.gif">`
        namePlayer1.innerHTML = `<img class="namePlayer1" src="assets/img/${player1.name}_name.png">`
        ...
        imagePlayer2.innerHTML = `<img class="fighter2" src="assets/img/characters/player2/${player2.name}-stay-p2.gif">`
        namePlayer2.innerHTML = `<img class="namePlayer1" src="assets/img/${player2.name}_name.png">`
        fightImage.innerHTML = `<img class="stats" src="assets/img/fightScreen02.png">`
        ...
        showPlayer1.innerHTML = `<img class="battleFighter1" src="assets/img/characters/player1/${player1.name}-stay-p1.gif">`
        showPlayer2.innerHTML = `<img class="battleFighter2" src="assets/img/characters/player2/${player2.name}-stay-p2.gif">`
        battlePlayer1.innerHTML = `<img class=battleImageP1" src="assets/img/${player1.name}_name.png">`
        battlePlayer2.innerHTML = `<img class=battleImageP2" src="assets/img/${player2.name}_name.png">`
...
if (player2.life < 1) {
    winner.innerHTML = `<img id="winnerImage" src="assets/img/characters/winner/${player1.name}-win2.png">`;
    winnerGif.innerHTML = `<img id="winnerGif" src="assets/img/characters/winner/${player1.name}-win.gif">`;
    ...
    resolveIn(1000).then(delay => {
        ...
        winner.innerHTML = `<img id="winnerImage" src="assets/img/characters/winner/${player2.name}-win2.png">`;
        winnerGif.innerHTML = `<img id="winnerGif" src="assets/img/characters/winner/${player2.name}-win.gif">`;
